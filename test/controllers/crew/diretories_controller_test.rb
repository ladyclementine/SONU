...
class Crew::DiretoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crew_diretory" do
    assert_difference('Crew::Diretory.count') do
      post crew_diretories_url, params: { crew_diretory: { description: @crew_diretory.description, photo: @crew_diretory.photo, title: @crew_diretory.title } }
    end
  ...
  test "should update crew_diretory" do
    patch crew_diretory_url(@crew_diretory), params: { crew_diretory: { description: @crew_diretory.description, photo: @crew_diretory.photo, title: @crew_diretory.title } }
